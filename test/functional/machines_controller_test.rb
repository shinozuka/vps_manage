...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { memory: @machine.memory, name: @machine.name, note: @machine.note, spu: @machine.spu }
    end
  ...
  test "should update machine" do
    put :update, id: @machine, machine: { memory: @machine.memory, name: @machine.name, note: @machine.note, spu: @machine.spu }
    assert_redirected_to machine_path(assigns(:machine))
  end
